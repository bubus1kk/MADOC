...
MADOC помогает заполнять типовые формы, проверять данные до создания документа и сохранять готовый результат в HTML или PDF. Приложение работает в нативном окне Windows, формирует документы локально и не открывает системный диалог печати.
